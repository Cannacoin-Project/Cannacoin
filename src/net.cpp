...
static const char *strMainNetDNSSeed[][2] = {
    ...
    // Add more DNS seeds to the list of necessary at a later date
    // {"cannachain.info", "dnsseed.cannachain.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"cannacoin.cc", "testnet-seed.cannacoin.cc"},
    // Add more DNS seeds to the list of necessary at a later date    
	// {"cannacoin.info", "testnet-seed.cannachain.info"},
    {NULL, NULL}
};
