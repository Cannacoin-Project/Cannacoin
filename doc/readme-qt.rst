Reddcoin-Qt: Qt4 GUI for Reddcoin
===============================
...
Alternatively, install `Qt Creator`_ and open the `reddcoin-qt.pro` file.
...
The static binary version of Reddcoin is linked against libdb4.8 (see also `this Debian issue`_).
...
installed causes reddcoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
